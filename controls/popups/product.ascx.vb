...
Partial Class webroot_web_controls_products
    Inherits System.Web.UI.UserControl

    Public Event SelectedItemChanged(ByVal NewProduct As Hrms3.PurProduct)
    ...
    Protected Sub uPnlControl_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles uPnlControl.Load
        ...
        Dim I As Hrms3.PurProduct = (New cls_products).SelectThis(Me.txtCode.Text)

        Me.txtCode.Text = I.ProductID & "\" & I.ProductName
        Me.txtHiddenCode.Value = I.ProductID
        Me.txtHiddenName.Value = I.ProductName
    ...
    Protected Sub uPnlModal_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles uPnlModal.Load
        Select Case Me.Request.Params("__EVENTARGUMENT")
            Case "gridview"
                ...
                Dim strSQL As String = "SELECT TOP 500 ProductID,ProductNo, ProductName,unitprice FROM purproducts WHERE ProductName LIKE '%" & contextKey & "%'"
                ...
                Me.GridView1.EmptyDataText = "No product found with this name."
            Case Else
    ...
    Public Property SelectedValue() As String
        ...
        Set(ByVal value As String)
            ...
            Dim i As Hrms3.PurProduct = (New cls_products).SelectThis(value)
            Me.txtCode.Text = i.ProductID & "\" & i.ProductName
        End Set
    End Property
