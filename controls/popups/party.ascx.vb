...
Partial Class webroot_web_controls_party
    ...
    Public Event SelectedItemChanged(ByVal NewParty As Hrms3.Company)
    ...
    Protected Sub uPnlControl_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles uPnlControl.Load
        ...
        Dim I As Hrms3.Company = (New cls_Companies).SelectThis(Me.txtCode.Text)

        Me.txtCode.Text = I.CompanyID & "\" & I.Company
        Me.txtHiddenCode.Value = I.CompanyID
        Me.txtHiddenName.Value = I.Company
    ...
    Protected Sub uPnlModal_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles uPnlModal.Load
        Select Case Me.Request.Params("__EVENTARGUMENT")
            Case "gridview"
                ...
                Dim strSQL As String = "SELECT TOP 500 CompanyID, Company FROM companies WHERE Company LIKE '%" & contextKey & "%'"
    ...
    Public Property SelectedValue() As String
        ...
        Set(ByVal value As String)
            ...
            Dim i As Hrms3.Company = (New cls_Companies).SelectThis(value)
            Me.txtCode.Text = i.CompanyID & "\" & i.Company
        End Set
    End Property
