<%@ Control Language="vb" AutoEventWireup="false" Inherits="nav_und" CodeFile="nav_mkt.ascx.vb" %>
<div id="SideNavBar">
    <ul>
        <li class="Header">
            ...
            <asp:Label ID="Label2" runat="server" AssociatedControlID="ExpandingImageButton1">Underwriting Menu</asp:Label></li></ul>
