<%@ Page Language="VB" MasterPageFile="~/webroot/web/modules/main.master" AutoEventWireup="false"
    CodeFile="company_branches_new.aspx.vb" Inherits="webroot_web_modules_admin_branch_edit" %>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="editColC">
                                            Branch Code 2</td>
                                        <td class="editColD">
                                            <asp:TextBox ID="txtbranchID2" runat="server" CssClass="textbox"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="editColA">
                                    ...
                                    <tr>
                                        ...
                                        <td class="editColC" style="width: 130px; height: 18px;">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="editColA">
                                            Region</td>
                                        <td class="editColB">
                                            <asp:DropDownList ID="ddlRegions" runat="server" CssClass="dropdown">
                                            </asp:DropDownList>
                                        </td>
                                        <td class="editColC">
                                            State</td>
