<%@ Page Language="VB" MasterPageFile="~/webroot/web/modules/main.master" AutoEventWireup="false" Inherits="employees_allowances_Index_aspx" CodeFile="allowances.aspx.vb" %>
            ...
            <tbody>
                <tr>
                    <td class="pageTitleBar">
                        <asp:Label ID="lbHeader" runat="server" Text="Label">Standard Allowances</asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                  ...
                  <tr>
                    <td class="sectionTabBar">
                       ...
                       <tr>
                    <td>
                        <uc:gridarea ID="gridarea1" runat="server" GroupName="admin_allowance_list" />
                    </td>
                    </tr>
                    <tr>
                    <td>
