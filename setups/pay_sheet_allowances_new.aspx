<%@ Page Language="VB" MasterPageFile="~/webroot/web/modules/main.master" AutoEventWireup="false"
    CodeFile="pay_sheet_allowances_new.aspx.vb" Inherits="webroot_web_modules_admin_pay_sheet_allowances_edit" %>
    ...
    <div id="masterContent">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="editColA">
                                            Grade Level:</td>
                                        <td class="editColB">
                                            <asp:DropDownList ID="cdbggradeLevel" runat="server" CssClass="dropdown">
                                            </asp:DropDownList>
                                        </td>
                                        <td class="editColC">
                                            Steps:</td>
                                        <td class="editColD">
                                            <asp:DropDownList ID="cdbSteps" runat="server" CssClass="dropdown">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="editColA">
                                            Allowance Description:</td>
                                        <td class="editColB">
                                            <asp:DropDownList ID="cdbAllowances" runat="server" CssClass="dropdown">
                                            </asp:DropDownList>
                                        </td>
                                        <td class="editColC">
                                            Amount:</td>
                                        <td class="editColD" runat="server">
                                            <asp:TextBox ID="txtAmount" runat="server" CssClass="textbox">0.00</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="editColA">
                                        ...
                                        <td class="editColC">
                                            &nbsp;</td>
                                        <td runat="server" class="editColD">
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="editColA">
        ...
        <div class="FloatingFooter">
            <div class="FloatingFooterDiv1">
                ...
                <mb:ConfirmedButton ID="cmdSaveAddNew" runat="server" CssClass="button" 
