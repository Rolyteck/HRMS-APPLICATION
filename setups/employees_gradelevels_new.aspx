<%@ Page Language="VB" MasterPageFile="~/webroot/web/modules/main.master" AutoEventWireup="false"
    CodeFile="employees_gradelevels_new.aspx.vb" Inherits="webroot_web_modules_admin_employees_gradelevels_edit" %>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="editColC">
                                            Pay Group</td>
                                        <td class="editColD">
                                            <asp:DropDownList ID="ddlPaygp" runat="server" CssClass="dropdown">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
