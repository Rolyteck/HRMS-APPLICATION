Partial Class employees_pay_sheet_allowances_Index_aspx
    ...
    Protected Sub cmdDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        Dim gridView As GridView = Me.paygridarea1.GridView
        ...
        For Each r As GridViewRow In gridView.Rows
            If CType(r.Cells(0).Controls(0), SelectorField.SelectorFieldCheckBox).Checked Then
                ...
                'do work here...
                Dim res As ResponseInfo = (New cls_HpayAllowances).Delete(PryKey)
    ...
    Protected Sub cmdNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdNew.Click
        Response.Redirect("pay_sheet_allowances_new.aspx?" & Request.QueryString.ToString)
    End Sub
End Class