<%@ Page Language="VB" MasterPageFile="~/webroot/web/modules/main.master" AutoEventWireup="false" CodeFile="delivary_edit.aspx.vb" Inherits="webroot_web_modules_accounts_asset_purchases_edit" title="Purchase Requisition Page" %>
                            ...
                            <table id="section1" cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="editColC">
                                            <asp:Label ID="lblNumber" runat="server" Text="Reference No:"></asp:Label>
                                        </td>
                                        <td class="editColD">
                    ...
                    <td class="pageFilterBox">
                        ...
                        <asp:Panel ID="Panel2" runat="server">
                            <table id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    <tr>
                                        <td class="editColA" style="height: 3px;">
                                            <br />
                                            Products:</td>
                                        <td style="height: 3px">
                                            <uc1:product ID="product1" runat="server" />
                                        </td>
                                        <td class="editColC" style="height: 3px;">
                                            <br />
                                            &nbsp;Quantity:</td>
                                        <td style="height: 3px">
                                            <br />
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 6px">
                                            <asp:TextBox ID="txtUnitPrice" runat="server" CssClass="textbox" 
                                                Visible="False" Width="48px"></asp:TextBox>
                                            </td>
                                        ...
                                        <td style="height: 6px">
                                            ...
                                            <asp:TextBox ID="txtPaidAmount" runat="server" CssClass="textbox" 
                                                Visible="False" Width="41px">0.00</asp:TextBox>
                                        </td>
                                    </tr>
